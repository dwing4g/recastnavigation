-- usage:
-- luajit dump_rcnavmesh.lua > ~$3060.txt
-- luajit dump_rcnavmesh.lua 1042 > ~$1042.txt
-- luajit dump_rcnavmesh.lua C:\svn\ark_resource\resource\develop\server\map\map1042\navmesh\1042.rcnavmesh > ~$1042.txt
...
--	a() o("tileDataSize: %6d (tileIdx: %4d/%4d, tileX: %2d/%2d, tileZ: %2d/%2d, x:%9.3f~%9.3f, z:%9.3f~%9.3f)",
	a() o("tileDataSize: %6d (tileIdx: %d/%d, tileX: %d/%d, tileZ: %d/%d, x:%.3f~%.3f, z:%.3f~%.3f)",
		...
		_G.bminZ + tileZ * _G.tileSize * _G.cs, _G.bminZ + (tileZ + 1) * _G.tileSize * _G.cs)
