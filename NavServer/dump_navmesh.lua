...
-- luajit dump_navmesh.lua test.navmeshes > test.navmeshes.txt
...
while true do
	if multi then
		a() o("tileDataSize: %d (tileIdx: %d)", readInt("tileDataSize"), i)
	end
	...
	a() o("    dtMeshHeader.x              : %d (%d ~ %d)", readInt("tileX"), _G.tileX * 16, _G.tileX * 16 + 16)
	a() o("    dtMeshHeader.y              : %d (%d ~ %d)", readInt("tileZ"), _G.tileZ * 16, _G.tileZ * 16 + 16)
